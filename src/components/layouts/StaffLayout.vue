...
<script>
import StudentNavigationBar from '../widgets/StaffNavigationBar.vue';
import StudentSideNavigationBar from '../widgets/StaffSideNavigation/StaffSideNavigationBar.vue';
