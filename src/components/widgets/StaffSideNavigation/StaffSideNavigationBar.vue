<template>
    <ion-menu type="push" content-id="main-content" side="start" :class="minisidebar ? 'sidebar-mini' : ''" style="width: fit-content;">
        <ion-header class="text-center">
            <ion-toolbar>
                <ion-buttons slot="start">
                    <ion-button routerLink="/student-layout/dashboard">
                        <ion-title class=" text-center">
                            <span class="font-weight-bold text-primary">BMA e-QMS</span>
                        </ion-title>
                    </ion-button>
                </ion-buttons>
            </ion-toolbar>
...
export default {
    ...
    components: {
        IonHeader, IonToolbar, IonButton, IonIcon, IonButtons, IonMenu, IonMenuButton, IonTitle, IonBreadcrumb, IonLabel, StaffSideNavigationBarItem
        , IonContent
    },
    props: {
