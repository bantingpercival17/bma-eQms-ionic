...
import { IonCard, IonCardContent, IonLabel, loadingController, alertController } from '@ionic/vue'
...
export default {
    ...
    components: {
        IonCard, IonCardContent, IonLabel, InputComponent, SelectComponent, FileAttachComponent
    },
    props: {
