    ...
    <div class="row m-0 align-items-center vh-100">
        ...
        <div class="col-lg-5 col-md-12">
            <div class="card-body">
                ...
                <h2 class="mb-2 text-center"><b>BMA e-QMS</b></h2>
                <p class="text-center">ELECTRONIC QUALITY MANAGEMENT SYSTEM</p>
                <form @submit.prevent="onLogin" class="row">
                    <div class="">
                        ...
                        <div class="col-lg-12 d-flex justify-content-between">
                            ...
                            <router-link :to="{ name: 'client-layout.forget-password' }" class="">Forgot
